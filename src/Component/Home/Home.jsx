...
function Home() 
{
    ...
    <a href="#qualification"><img src="https://i.ibb.co/981VJf5/degree-logo.jpg" alt="" width="30px" height="30px" className="rounded-full"/></a>
                ...
                <div className="flex justify-center gap-4 mt-11">
                        ...
                        <a href="https://drive.google.com/file/d/1suO1dHB-YzbnKLOsgyR0RwVdna5zCjIA/view?usp=drive_link" target="blank" className='bg-blue-500 px-3 py-2 rounded-lg text-2xl text-white'>DownLoad CV</a>
